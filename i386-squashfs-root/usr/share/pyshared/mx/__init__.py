""" mx Extension Series for Python
...
"""
# eGenix mx Extension Series version number
#
# This is always the same as the eGenix mx Base distribution version
# number. Note: The subpackages have their own versions.
__version__ = '3.2.0'
