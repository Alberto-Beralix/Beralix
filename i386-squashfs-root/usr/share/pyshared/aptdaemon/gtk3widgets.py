...
class _DetailsExpanderMessageDialog(Gtk.MessageDialog):
    """
    ...
    def set_details(self, details):
        ...
        expander = Gtk.Expander.new_with_mnemonic(_("_Details"))
        ...
        self.get_message_area().add(expander)
        expander.show_all()
...
class AptMessageDialog(_DetailsExpanderMessageDialog):
    ...
    def __init__(self, enum, details=None, parent=None):
        ...
        _DetailsExpanderMessageDialog.__init__(self, text, desc,
                Gtk.MessageType.INFO, details, parent)
...
class AptErrorDialog(_DetailsExpanderMessageDialog):
    ...
    def __init__(self, error=None, parent=None):
        ...
        _DetailsExpanderMessageDialog.__init__(self, text, desc,
                Gtk.MessageType.ERROR, error.details, parent)
