...
%variants = (
    ...
    'cm' => {
	'English (Cameroon Dvorak)' => 'dvorak',
	'English (Cameroon qwerty)' => 'qwerty',
	'French (Cameroon azerty)' => 'azerty',
	...
	'Serbian (Latin)' => 'latin',
	'Serbian (Z and ZHE swapped)' => 'yz',
	'Serbian (with guillemets)' => 'alternatequotes',
    },
    'ru' => {
	'Bashkirian' => 'bak',
	'Chuvash' => 'cv',
