...
var UpdateRestartNotifierPrivate = {
  ...
  remindListeners: function URNP_remindListeners() {
    this.listeners.forEach(function(listener) {
      try {
        if (listener.onUpdatedReminder)
          listener.onUpdatedReminder();
      } catch(e) {
        Cu.reportError(e);
      }
    });
  ...
  notifyListeners: function URNP_notifyListeners() {
    try {
      ...
      }, 60000, Ci.nsITimer.TYPE_REPEATING_SLACK);
    } catch(e) {
      Cu.reportError(e);
    }
  ...
  addListener: function URNP_addListener(aListener) {
    ...
    if (aListener.onUpdatedReminder &&
        (typeof(aListener.onUpdatedReminder) != "function"))
      throw "onUpdatedReminder is not a valid function"
