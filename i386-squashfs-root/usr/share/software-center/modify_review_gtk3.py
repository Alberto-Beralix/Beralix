...
class BaseApp(SimpleGtkbuilderApp):
    ...
    def __init__(self, datadir, uifile):
        ...
        self.login_spinner_vbox.pack_start(self.status_spinner, False, False, 0)
        ...
        self.submit_spinner.set_size_request(*Gtk.icon_size_lookup(Gtk.IconSize.SMALL_TOOLBAR)[:2])
        #submit error image
        self.submit_error_img = Gtk.Image()
        self.submit_error_img.set_from_stock(Gtk.STOCK_DIALOG_ERROR, Gtk.IconSize.SMALL_TOOLBAR)
        #submit success image
        self.submit_success_img = Gtk.Image()
        self.submit_success_img.set_from_stock(Gtk.STOCK_APPLY,  Gtk.IconSize.SMALL_TOOLBAR)
        #submit warn image
        self.submit_warn_img = Gtk.Image()
        self.submit_warn_img.set_from_stock(Gtk.STOCK_DIALOG_INFO,  Gtk.IconSize.SMALL_TOOLBAR)
    ...
    def _change_status(self, type,  message):
        ...
        if type == "progress":
            ...
            self.status_hbox.pack_start(self.submit_success_img, False, False, 0)
