...
unless(defined(&_ASM_X86_UNISTD_64_H)) {
    ...
    eval 'sub __IGNORE_getcpu () {1;}' unless defined(&__IGNORE_getcpu);
    ...
    unless(defined(&__NO_STUBS)) {
	eval 'sub __ARCH_WANT_OLD_READDIR () {1;}' unless defined(&__ARCH_WANT_OLD_READDIR);
	eval 'sub __ARCH_WANT_OLD_STAT () {1;}' unless defined(&__ARCH_WANT_OLD_STAT);
	eval 'sub __ARCH_WANT_SYS_ALARM () {1;}' unless defined(&__ARCH_WANT_SYS_ALARM);
	eval 'sub __ARCH_WANT_SYS_GETHOSTNAME () {1;}' unless defined(&__ARCH_WANT_SYS_GETHOSTNAME);
	eval 'sub __ARCH_WANT_SYS_PAUSE () {1;}' unless defined(&__ARCH_WANT_SYS_PAUSE);
	eval 'sub __ARCH_WANT_SYS_SGETMASK () {1;}' unless defined(&__ARCH_WANT_SYS_SGETMASK);
	eval 'sub __ARCH_WANT_SYS_SIGNAL () {1;}' unless defined(&__ARCH_WANT_SYS_SIGNAL);
	eval 'sub __ARCH_WANT_SYS_UTIME () {1;}' unless defined(&__ARCH_WANT_SYS_UTIME);
	eval 'sub __ARCH_WANT_SYS_WAITPID () {1;}' unless defined(&__ARCH_WANT_SYS_WAITPID);
	eval 'sub __ARCH_WANT_SYS_SOCKETCALL () {1;}' unless defined(&__ARCH_WANT_SYS_SOCKETCALL);
	...
	eval 'sub __ARCH_WANT_SYS_LLSEEK () {1;}' unless defined(&__ARCH_WANT_SYS_LLSEEK);
	eval 'sub __ARCH_WANT_SYS_NICE () {1;}' unless defined(&__ARCH_WANT_SYS_NICE);
	eval 'sub __ARCH_WANT_SYS_OLD_GETRLIMIT () {1;}' unless defined(&__ARCH_WANT_SYS_OLD_GETRLIMIT);
	eval 'sub __ARCH_WANT_SYS_OLD_UNAME () {1;}' unless defined(&__ARCH_WANT_SYS_OLD_UNAME);
	eval 'sub __ARCH_WANT_SYS_OLDUMOUNT () {1;}' unless defined(&__ARCH_WANT_SYS_OLDUMOUNT);
	eval 'sub __ARCH_WANT_SYS_SIGPENDING () {1;}' unless defined(&__ARCH_WANT_SYS_SIGPENDING);
	eval 'sub __ARCH_WANT_SYS_SIGPROCMASK () {1;}' unless defined(&__ARCH_WANT_SYS_SIGPROCMASK);
	eval 'sub __ARCH_WANT_SYS_RT_SIGACTION () {1;}' unless defined(&__ARCH_WANT_SYS_RT_SIGACTION);
	eval 'sub __ARCH_WANT_SYS_RT_SIGSUSPEND () {1;}' unless defined(&__ARCH_WANT_SYS_RT_SIGSUSPEND);
