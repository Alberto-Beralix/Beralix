...
unless (defined &__GLIBC_MINOR__) { sub __GLIBC_MINOR__() { 13 } }
...
unless (defined &__INT64_C) { sub __INT64_C($) { my ($c) = @_; "${c}LL" } }
...
unless (defined &__INTMAX_C) { sub __INTMAX_C($) { my ($c) = @_; "${c}LL" } }
...
unless (defined &__UINT64_C) { sub __UINT64_C($) { my ($c) = @_; "${c}ULL" } }
...
unless (defined &__UINTMAX_C) { sub __UINTMAX_C($) { my ($c) = @_; "${c}ULL" } }
...
unless (defined &__VERSION__) { sub __VERSION__() { "\"4\.6\.1\"" } }
