...
=head2 gravity = Pango::Gravity::get_for_matrix ($matrix)

=over

=item * $matrix (Pango::Matrix) 

=back



=head2 gravity = Pango::Gravity::get_for_script ($script, $base_gravity, $hint)

=over

=item * $script (Pango::Script) 

=item * $base_gravity (Pango::Gravity) 
...
=head2 boolean = Pango::Gravity::is_vertical ($gravity)
...
=head2 double = Pango::Gravity::to_rotation ($gravity)
