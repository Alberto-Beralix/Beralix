cmd_scripts/basic/fixdep := gcc -Wp,-MD,scripts/basic/.fixdep.d -Iscripts/basic -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -o scripts/basic/fixdep /build/buildd/linux-3.0.0/scripts/basic/fixdep.c  

source_scripts/basic/fixdep := /build/buildd/linux-3.0.0/scripts/basic/fixdep.c
