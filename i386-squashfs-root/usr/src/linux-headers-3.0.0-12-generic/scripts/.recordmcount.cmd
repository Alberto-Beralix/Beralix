cmd_scripts/recordmcount := gcc -Wp,-MD,scripts/.recordmcount.d -Iscripts -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -o scripts/recordmcount /build/buildd/linux-3.0.0/scripts/recordmcount.c  

source_scripts/recordmcount := /build/buildd/linux-3.0.0/scripts/recordmcount.c
...
deps_scripts/recordmcount := \
  ...
  /build/buildd/linux-3.0.0/scripts/recordmcount.h \
