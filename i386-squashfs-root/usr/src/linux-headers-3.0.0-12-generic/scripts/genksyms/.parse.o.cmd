cmd_scripts/genksyms/parse.o := gcc -Wp,-MD,scripts/genksyms/.parse.o.d -Iscripts/genksyms -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -Wno-uninitialized  -I/build/buildd/linux-3.0.0/scripts/genksyms -Iscripts/genksyms -c -o scripts/genksyms/parse.o scripts/genksyms/parse.c
